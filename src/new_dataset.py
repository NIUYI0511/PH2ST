...
class NewDataset(STDataset):
    ...
    def load_emb(self, name: str, emb_name: str = 'global', idx: int = None):
        ...
        # path = f"{self.emb_dir}/{emb_name}/virchow2/{name}.h5"
        # path = f"{self.emb_dir}/{emb_name}/conch_v1_5/{name}.h5"
        # path = f"{self.emb_dir}/{emb_name}/ctranspath/{name}.h5"
